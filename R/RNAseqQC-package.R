...
#' @importFrom magrittr %>%
#' @importFrom purrr map map_dbl imap map_dfr walk
#' @importFrom tidyr pivot_longer pivot_wider
#' @importFrom stringr str_sort str_c str_detect str_replace_all
#' @importFrom ggplot2 ggplot aes geom_boxplot geom_function geom_point geom_line element_text element_line
...
#' @importFrom stats as.dist cor dist ecdf p.adjust prcomp
